...
function shopcarSuc(data) {
  var goodsArr = JSON.parse(localStorage.getItem('goods')); // console.log(goodsStr);
  //购物车新增单条物品信息
  ...
  if (goodsArr.length > 0) {
    ...
    var ullist = document.querySelector('ul.shopcar-goodslist'); //全选全不选
    ...
    $('ul.shopcar-goodslist').on('click', '.delete', function () {
      ...
      $(this).parent().parent().remove(); // 更新localstorage
